...
const SUBSCRIPTION_BOOK_ADDED = "BOOK_ADDED"
...
const resolvers = {
  Mutation: {
    addBook: async (root, args, context) => {
      ...
      pubsub.publish(SUBSCRIPTION_BOOK_ADDED, { bookAdded: newBook })
      return newBook
    },
  ...
  Subscription: {
    bookAdded: {
      subscribe: () => pubsub.asyncIterator([SUBSCRIPTION_BOOK_ADDED]),
    },
  },
}
